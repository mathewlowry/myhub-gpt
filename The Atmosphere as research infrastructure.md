...
* standard.site allows each research team to upgrade their website into *scaffolding* for the researchers' activities across the Atmosphere
* each research team website thus derives *collective* knowledge from the *individual* researchers' activities (networking, publishing, curating, commenting...)
* and then amplifies it: each such website is a node in the Atmosphere, so anyone can connect them together like Lego bricks, creating new structures to support global knowledge discovery, sensemaking, and collaboration.
