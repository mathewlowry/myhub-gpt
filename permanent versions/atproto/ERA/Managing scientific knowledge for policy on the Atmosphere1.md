...
In my AtmosphereConf workshop last March in Vancouver (see [[The Atmosphere as research infrastructure]], I explored how research teams could create more collective intelligence by: 
...
The knowledge broker isn't the only beneficiary. Science journalists can self-serve on what a community of researchers is actually discussing. Industry can identify relevant expertise without waiting for a conference. An LLM layer sitting on top of the cluster — using retrieval-augmented generation over the knowledge base — can synthesise findings and answer questions directly.
