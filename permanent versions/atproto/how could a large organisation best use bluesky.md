...
* **custom feeds**: anyone can use a variety of competing tools to create a custom feed, which shows all Bluesky posts filtered and shorted by the creator's criteria. And they can share these custom feeds with friends, who can "pin" it to their app for easy access (see [everything tagged bluesky custom feeds ](https://myhub.ai/@mathewlowry/?tags=bluesky+custom+feeds).
* **Starter Packs**: "These package a list of up to 150 people, a feed of their posts plus (optionally) custom feeds relevant to the Pack's topic." - [Three things you probably didn't know about Bluesky](https://myhub.ai/items/three-things-you-probably-didnt-know-about-bluesky)
...
There are plenty of complex algorithms you can build with powerful tools like [graze.social](https://www.graze.social/), but for the above purposes a simple "list + hashtag" feed is sufficient:
...
![[Pasted image 20251206193636.png]]
...
**Since the Ahoy conference I've been developing solutions for this problem with Bart Jan Schuman ([@schuman.de](https://bsky.app/profile/schuman.de)), who's spent 30 years working on enterprise infrastructure for the financial sector.** 
...
![[Pasted image 20251206194431.png]]
**Fig 8**. *[ATconnect](https://www.atconnect.eu/)  links your HR data with your IT system and your Bluesky presence.* 
...
- changes in this version: 
	- rewrote to include the EuroskyLive presentation and surrounding context
- version control
    - this is version: 4
    - this is the current version: [[how could a large organisation best use bluesky]]
    - here is the previous version: [[how could a large organisation best use bluesky 3]]
