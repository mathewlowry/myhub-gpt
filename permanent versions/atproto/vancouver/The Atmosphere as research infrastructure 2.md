---
creation date: 2026-04-03 15:10
modification date: 093 April 2026 15:10:12
---
...
The audience seemed to know their way around the Atmosphere, so - contrary to the [workshop programme](https://atscience.leaflet.pub/3mfz526irfs2y/l-quote/019ca0e7-89cc-7dd5-a093-83968184e2bf~4_0-4_8#019ca0e7-89cc-7dd5-a093-83968184e2bf~4_0) I published a few weeks ago - we skipped the "Intro to atproto" and jumped straight to the core question: how and why can research teams integrate their website and Atmosphere apps to improve science comms, collective knowledge discovery, sensemaking, and collaboration?
...
* each research team website can derive *collective* knowledge from the *individual* researchers' activities across the Atmosphere (networking, publishing, curating, commenting...)
* standard.site allows each research team to upgrade their website into *scaffolding* for the researchers' activities 
* and then **amplifies it**: each website is a node in the Atmosphere,  and so can be connected like Lego bricks, creating new structures to support global knowledge discovery, sensemaking, and collaboration.

It's worth noting that this is not limited to research teams: any organisation interested in knowledge can do this (looking at you, News).
...
After the scene setter, I kept the imaginary microphone to summarise [the presentation I gave in Berlin last November](https://mathewlowry.medium.com/how-newsrooms-scientific-institutions-governments-can-best-use-bluesky-ee97d840a058) at the Eurosky launch. The core argument then was that Bluesky starter packs and custom feeds let institutions build structures on Bluesky which are useful to both them and their individual researchers. 

I opened with this because it was an early example of the **win-wins I wanted to explore throughout the workshop**:

* The institutions have the resources to build and maintain structures on the Atmosphere, so these structures must benefit the institution
* But these structures are only useful if the researchers use them, so they must also benefit individual researchers
* The fact that researchers can take their network and content with them when they change institution is therefore essential.
...
### Websites just got social (Brendan, [7:12](https://youtu.be/3D4lbDZE_c4?si=Oy8UDn8F_7RTRXdR&t=432) - 8:25)

Shortly after Berlin, [Leaflet.pub](https://leaflet.pub/) and two other companies launched [standard.site](https://standard.site/) — a lexicon that allows websites to appear natively in the ATmosphere. As a result, two open protocols can now cooperate: http, which underpins Web publishing, and atproto, which underpins the social Atmosphere. 
...
*More:* Shortly after my workshop, Brendan ran [an entire workshop dedicated to Atmospheric Publishing](https://atmosphereconf.org/event/XxPK17j), so I was extremely grateful that he found the time to contribute to mine. 
### Example: event co-creation (me again, [8:25](https://youtu.be/3D4lbDZE_c4?si=FG9RGo_AZONrD39n&t=505)-14:52)

I then took the floor again briefly to show what this could look like in practice — drawing on a [short blog post](https://experiments.myhub.ai/permanent_versions/atproto/vancouver/simple_sites_but_powerful_communities) that itself summarises and generalises a [four-part series on co-creating physical events with your online community](https://experiments.myhub.ai/co-creating_your_physical_event_with_your_online_community)by integrating the Atmosphere with your website.
...
### Collective listening: from Sill to "Our Sill" (Tyler, [14:52](https://youtu.be/3D4lbDZE_c4?si=yzm23B7bFyXJowMs&t=892)-15:47)

[Sill](link) is part of my daily routine. It watches what the people I follow are sharing and discussing across Bluesky and delivers the most popular links as a morning email digest, turning my social graph into a content discovery tool.
...
* [How and Why News Organizations Should Build on the ATProtocol](https://atmosphereconf.org/event/VLXBbzJ)
* [Rethinking the Client: Why User Choice is the Key to Growth for ATProto](https://atmosphereconf.org/event/MelQ8Ak)

### Collective curation: Adding Groups to Semble (Wesley, [15:47](https://youtu.be/3D4lbDZE_c4?si=ojzKfiRqHCkGhzs1&t=947)-16.47)

 [Semble.so](https://semble.so/) is a curation tool that lets you curate collections of content, either for yourself, or as open collections anyone can contribute to. The Cosmik Network team behind it organised the entire ATScience Day, and the tool is developing fast.
...
* [Semble: A social knowledge network for research on ATProto](https://atmosphereconf.org/event/ats26-semble)
* [Semble: Rediscovering the Magic of Trails](https://atmosphereconf.org/event/OD6Gd0A)

### The missing piece: Skysquare

Another founder, Travis Simpson of [Skysquare](https://skysquare.app/) was also going to take part, but he fell ill in Vancouver and couldn't attend. He did, however, provide [a video for the session he was going to give](https://symbolscape.wistia.com/medias/9nx22shegs) earlier that day.
...
## Conclusion ([16:47](https://youtu.be/3D4lbDZE_c4?si=YPs4dI-Y4IMyEn-F&t=1007)-18:31)

I'll close with the key points from the last ~100 seconds:

* The entire ATScience Day (Friday) was amazing, so I hope to follow up with more blog posts, in cooperation with the rest of the ATScience team
* From the way people talked about ATScience throughout the rest of the weekend, it's clear that the science sector is at the forefront of exploring the potential of this protocol 
* For me the most significant development is the above-mentioned integration between the Web and the Atmosphere. This will give the Atmosphere a huge boost, probably *square* the value of the Web, and is our best shot at helping people migrate away from US big tech legacy social media. 
