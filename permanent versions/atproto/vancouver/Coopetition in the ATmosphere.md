...
*(This is version 2 of the description of my atproto.science conference workshop (March 2026, Vancouver), published using the [permanent versions pattern](https://mathewlowry.medium.com/two-wiki-authors-and-a-blogger-walk-into-a-bar-7106c8376c6e) on my wiki, where I share my evolving thoughts to help collect ideas along the way. Version control & links in the footer.)*
...
Back then, however, there was unguarded optimism. Today, the optimism is there, but it feels [a little wiser](https://bsky.app/profile/mathewlowry.eurosky.social/post/3mem2mkcrec2t), and far less oriented towards VC-fuelled instant wealth. We know that the commons we're building can be captured. 
...
* independent teams first built highly distinct apps using the same underlying lexicon (eg [deck.blue](https://deck.blue/), [flashes](https://apps.apple.com/us/app/flashes-for-bluesky/id6741443033), [anisota.net](https://anisota.net/feed))
* we're now seeing "stage 2" cooperation, where different teams, having built different lexicons for similar use cases, are now cooperating (eg [standard.site](https://standard.site/), from the teams behind [leaflet](https://leaflet.pub/), [pckt.blog](https://pckt.blog/) and [offprint](https://offprint.app/)). 
