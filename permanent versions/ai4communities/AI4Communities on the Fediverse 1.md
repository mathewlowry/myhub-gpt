...
My [manifesto posts of 1/1/23](https://mathewlowry.medium.com/a-minimum-viable-ecosystem-for-collective-intelligence-7738848ce9c4) reflected *some* knowledge of the Fediverse, which I'd been tracking for a few years. My early versions of the [[AI4Communities intro]], from which the following was extracted, reflected that bias. 
...
* how effective will some of the AI services explored in  [[AI4Communities intro]] be on the Fediverse? After all, a content discovery algorithm cannot discover content from an instance which isn't connected in some way to its home village
...
- changes in this version: 
	- this is version 1, extracted from [[AI4Communities intro]] and lightly edited
- version control
    - this is version: 1
