...
### Introduction
While Experiment 4 is an evolution of Experiments 2 & 3 in that the same collection and summariser was used, and one of the end goals is a visualisation of a Collection's main themes.

However, I'm trying a completely new Prompt ([[Prompt 2b themes]]), reflecting a new purpose, reflecting the problems discovered earlier:
* Hallucinations
...
* Finally, a mindmap's centralised focus shows each theme connected to the central node and its subthemes. Where are the resources?
...
* So far I've been unable to create anything useful in Mermaid, nor find another library able to create a concept map which is *not* a centralised mindmap
